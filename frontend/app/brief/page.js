                                ...
                                <div style={{ position: "relative", width: "100%", height: "280px", background: "var(--card-hover)", overflow: "hidden" }}>
                                    <img
                                        ...
                                        onError={e => {
                                            ...
                                            e.target.parentElement.style.background = "linear-gradient(135deg, #0a1929 0%, #0d1117 100%)";
                                            e.target.parentElement.innerHTML = `
                        <div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;">
                          <div style="font-size:48px;font-weight:800;font-family:'Syne',sans-serif;color:#00d4ff;opacity:0.15;">NEXUS</div>
                        </div>
                      `;
                                        }}
                                    />
